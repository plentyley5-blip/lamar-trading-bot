...
class handler(
    ...
    def do_GET(self):
        ...
        try:
            ...
            # New submissions are completed and saved before the
            # submit endpoint returns. This branch protects old
            # stale jobs created by earlier backend versions.
            json_response(
                self,
                200,
                {
                    ...
                    "error":
                        (
                            "This analysis job was created by "
                            "an older backend version. Please "
